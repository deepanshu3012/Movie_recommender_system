...
def fetch_poster(movie_id):
    url='https://api.themoviedb.org/3/movie/{}?api_key=fde40b8457e3ec056d2a3ac4f57a582e'.format(movie_id)
...
movies=pickle.load(open('artifacts/movie.list.pkl', 'rb'))
similarity=pickle.load(open('artifacts/similarity.list.pkl', 'rb'))
